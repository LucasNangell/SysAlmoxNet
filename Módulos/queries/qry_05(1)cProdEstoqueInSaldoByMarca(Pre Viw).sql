...
-- Tipo: SELECT
SELECT [qry_05(1)aProdEstoqueIn(Viw)].ProdutoFullIDfk, [qry_05(1)aProdEstoqueIn(Viw)].ProdMarcaIDfk, [qry_05(1)aProdEstoqueIn(Viw)].ProdMarcaStr, Sum([QtdEmbsIn]*[Prods_Emb]) AS SaldoPorMarca
...
GROUP BY [qry_05(1)aProdEstoqueIn(Viw)].ProdutoFullIDfk, [qry_05(1)aProdEstoqueIn(Viw)].ProdMarcaIDfk, [qry_05(1)aProdEstoqueIn(Viw)].ProdMarcaStr;
