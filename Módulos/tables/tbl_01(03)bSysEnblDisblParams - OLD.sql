-- Tabela: tbl_01(03)bSysEnblDisblParams - OLD
-- Registros: 89

CREATE TABLE tbl_01(03)bSysEnblDisblParams - OLD (
...
ALTER TABLE tbl_01(03)bSysEnblDisblParams - OLD ADD PRIMARY KEY (EnbleDsbleSetID);
