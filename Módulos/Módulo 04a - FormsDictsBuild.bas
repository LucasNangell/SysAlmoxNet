...
Public Sub pbSub32_TriggCtrlDictCheck(vTagSection As Variant, cTriggCtrl As Control)
    Dim vA, vB, vC
    
    '---------------------------------------------------------------------------
    ' Com o dicionário de Triggers criado passa a fazer a checagem pra detecção de erros
    '---------------------------------------------------------------------------
