-- Consulta: qry_04(01)bProdutosFull_Setor(Edt-Lst)
-- Tipo: SELECT
...
FROM [qry_02(03)aProdutosBase] RIGHT JOIN ([qry_10(04)aProdutoFull_SetorJct] RIGHT JOIN [qry_04(01)aProdutosFull(Edt)] ON [qry_10(04)aProdutoFull_SetorJct].ProdutoFullIDfk = [qry_04(01)aProdutosFull(Edt)].ProdutoFullID) ON [qry_02(03)aProdutosBase].ProdutoBaseID = [qry_04(01)aProdutosFull(Edt)].ProdutoBaseIDfk
